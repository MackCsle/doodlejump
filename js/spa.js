        ...
        constructor(container) {
            ...
            this.scoresPage = {
                ...
                render: (className) => {
                    ...
                    <section class="${className}">
                        ...
                        <table id="scores" class="scores-table" onanimationend="buildTable()">
                            <thead>
                                <th>Name</th>
                                <th>Score</th>
                            </thead>
            ...
            this.gamePage = {
                ...
                render: (className) => {
                    ...
                    <img src="img/tap.png" class="tap-pic" title="tap to start" id="start" onclick="start()">
                        <div class="blue-bg">
                            <div id="container">
                                <div id="score"></div>
                                <div id="game-over-block">
                                    ...
                                    <a class="button" onclick="addScore()">Add your score</a>
                                    <a class="button" href="#main" onclick="toMenu()">Back to menu</a>
                                </div>
                            <form class="form" id="form">
                                <h2>Your name:</h2>
                                <input id="name" type="text" placeholder="Name">
                                <p id="warning">Name can't be empty!</p>
                                <a class="button" onclick="sendToServer()">Send</a>
                                <a class="button" id="close" href="#main" onclick="toMenu()">Back to menu</a>
                            </form>
